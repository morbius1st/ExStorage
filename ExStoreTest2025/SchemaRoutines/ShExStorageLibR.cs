...
namespace ShExStorageR.ShExStorage
{
	...
	#region Entity public
		...
		public bool DoesSheetEntityExist(ExId exid)
		{
			...
			ExStoreRtnCode rtnCode = FindExStorageInfo(exid, exid.ExsIdSheetSchemaName, 
				out ds, out e, out s);
		...
		public bool DoesLockEntityExist(ExId exid)
		{
			...
			ExStoreRtnCode rtnCode = FindExStorageInfo(exid, exid.ExsIdLockSchemaName, 
				out ds, out e, out s);
		...
		public ExStoreRtnCode FindExStorageInfo(ExId exid, string name, 
