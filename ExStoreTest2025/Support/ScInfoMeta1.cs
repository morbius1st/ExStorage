...
// created:   10/24/2022 7:20:59 PM
	...
	namespace ShExStorageC.ShSchemaFields.ShScSupport
	{
		public static class ScInfoMeta1
		{
			...
			private static Dictionary<string, string> mapTest =  new () { { "A", "1" }, { "B", "2" }, { "C", "3" } };
			private static List<string> arrayTest =  new () {"alpha", "beta", "delta", "gamma"};
			...
			{SK2_TEST_MAP,         new ScFieldDefMeta1<SchemaSheetKey> (SK2_TEST_MAP     , "TestMap"    , "Map Test"                     ,new DynaValue(mapTest)                                      , DL_ADVANCED)},
			{SK2_TEST_ARRAY,       new ScFieldDefMeta1<SchemaSheetKey> (SK2_TEST_ARRAY   , "TestArray"  , "Map Array"                    ,new DynaValue(arrayTest)                                    , DL_ADVANCED)},
