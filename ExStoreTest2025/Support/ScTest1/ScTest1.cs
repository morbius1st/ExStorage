...
using static ExStoreTest2025.Support.ScTest1.ScConst;
...
namespace ExStoreTest2025.Support.ScTest1
{
	...
	public class ScTest1
	{
		...
		public void testA()
		{
			...
			{
				Msgs.WriteLine($"key {kvp.Key.Value,-12} | name {kvp.Value.Name,-12} | desc {kvp.Value.Desc,-12}");
			}
