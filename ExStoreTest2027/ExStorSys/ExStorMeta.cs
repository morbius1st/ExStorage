...
namespace ExStorSys
{
	...
	{
		PC_START = 0,
		PC_BEGIN_UI_STATUS = 50,
		PC_END_UI_STATUS = 100,
	}
	...
	public enum PropertyId
	{
		...
		// general / ui status = > 50 && < 100

		PI_GEN_RESTART_REQD	       = PropertyCategory.PC_BEGIN_UI_STATUS, // wired
		PI_GEN_NEEDS_SAVING	       , // wired

		PI_WBK_IS_MOD_EXO          , // wired
		PI_WBK_APPLY_BTN_STAT, // wired
		PI_WBK_UNDO_BTN_STAT, // wired


		PI_SHT_IS_MOD_EXO, // wired
		PI_SHT_APPLY_BTN_STAT, // wired
		PI_SHT_UNDO_BTN_STAT, // wired
		PI_SHT_FAM_LST_IS_DIRTY, // wired
		PI_SHT_IS_MOD_FAM_LST_WKG, // wired

		PI_XD_APPLY_BTN_SHTS_LST, // wired
		PI_XD_UNDO_BTN_SHTS_LST, // wired
	}
