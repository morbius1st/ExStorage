...
namespace ExStoreTest
{
	internal class AppRibbon : IExternalApplication
	{
		...
		private const string NAMESPACE_PREFIX = "ExStoreTest.Assets";

		private const string PANEL_NAME = "ExStoreTest";


		private const string BUTTON_NAME = "ExStoreTest";
		private const string BUTTON_TEXT = "ExStoreTest";
		...
		private const string CLASSPATH = "ExStoreTest.";
