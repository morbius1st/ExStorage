...
namespace ShExStorageN.ShSchemaFields
{
	...
	/// </summary>
	public abstract class AShScSheet<TShtKey, TShtFlds, TRowKey,
		TRowFlds, TRow> :
	...
	public abstract class AShScRow<TKey, TField> : AShScFields<TKey, TField>
		where TKey : Enum
		...
		where TField : IShScFieldBase1<TKey>, new()
	{
		...
		public Dictionary<TKey, TField> Fields { get; protected set; }
