...
namespace ProcessTests3
{
	public class Tests1 : ATestsWbk, ITests
	{
		...
		public Tests1()
		{
			...
			RunTheseTests.AddRange(["Test101B", "Test102B", ]);
			...
			register(nameof(Test101B), Test101B, test101bDesc);
			register(nameof(Test102A), Test102A, test102aDesc);
			register(nameof(Test102B), Test102B, test102bDesc);
		...
		private string test101bDesc = "change user field (name mod)";
		public bool Test101B(string testId)
		{
			// remember to register routine
			R.AddRouteEnter();
			bool result = true;
			...
			uiTests2 = new ([
				//                                  A    B    C     D    E     F    G     H    I
				V2.Ts2_WbkUiEndSequenceA.SetTests(["F", "F", "T",  "T", "T",  "T", "T",  "F", "F"]),
			]);
		...
		// matches example 1B
		private string test102bDesc = "change user field (name mod) then undo all";
		public bool Test102B(string testId)
		{
			// remember to register routine
			R.AddRouteEnter();
			bool result = true;
			...
			tests2 = new ([
				V2.Ts2_WbkStdTestsA.SetTests(["Init", "F", "N",  "Alt2", "T", "X",  "Upd1", "T", "T",  "T", "T", "T"]),
				V2.Ts2_WbkStdTestsA.SetTests(["Init", "F", "N",  "Init", "F", "N",  "Init", "F", "N",   "F", "F", "F"])
			]);
