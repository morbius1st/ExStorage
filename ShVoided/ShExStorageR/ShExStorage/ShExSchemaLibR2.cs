...
{
	public class ShExSchemaLibR2<TSht, TRow, TLok, TShtKey, TShtFlds, TRowKey, TRowFlds, TLokKey, TLokFlds> : INotifyPropertyChanged
	...
	#region private fields
		...
		public ShExStorManagerR2<TSht, TRow, TLok, TShtKey, TShtFlds, TRowKey, TRowFlds, TLokKey, TLokFlds>  smR2 { get; set; }

	#endregion

	#region ctor

		public ShExSchemaLibR2() { }
...
*/
	...
	#region system overrides
		...
		{
			return $"this is {nameof(ShExSchemaLibR2<TSht, TRow, TLok, TShtKey, TShtFlds, TRowKey, TRowFlds, TLokKey, TLokFlds>)}";
		}
...
// B2
		private SchemaBuilder makeSheetPartialSchema<TK, TF>(AShScFields2<TK, TF> flds)
			where TK : KEY
			where TF : IShScFieldData2<TK>, new()
		{
...
// D1
		private void addSchemaFields<TKey, TFields>
			...
			where TKey : KEY
			where TFields : IShScFieldData2<TKey>, new()
		{
...
// J1
		private void addRowSchema(AShScRow2<TRowKey, TRowFlds> row)
		{
...
// K1
		private Schema makeRowSchema(AShScRow2<TRowKey, TRowFlds> row)
		{
...
// WD
		private void writeData<TKey, TFld>(Entity e, Schema s, AShScFields2<TKey, TFld> data)
			where TKey : KEY
			where TFld : IShScFieldData2<TKey>, new()
		{
...
// Wr
	...
	#region Primary Methods
		...
		/// </summary>
		public void ReadData<TKey, TFlds>(Entity e, AShScFields2<TKey, TFlds> data)
			where TKey : KEY
			where TFlds :  IShScFieldData2<TKey>, new()
		{
	...
	#region private methods
		...
		{
			List<Entity> subSchema = smR2.StorLibR.getSubEntities(e);
		...
		// public ShExStorManagerR<TSht, TRow, TLok, TShtKey, TShtFlds, TRowKey, TRowFlds, TLokKey, TLokFlds> ShExStorManagerR
		// {
		// 	get => default;
		// 	set
		// 	{
