...
namespace ExStorSys
{
	...
	*/
	...
	public enum ItemUsage : ulong
	{
		...
		IU_IS_RECORD		= 1ul << 6,						// this item is a record keeping field (e.g. dates and user names)
		IU_IS_USER			= 1ul << 7,						// this item's status is controlled by user action
		IU_IS_ALT_SRC_A		= 1ul << 8,						// this item's status is controlled by an alt source (type A)
		IU_IS_ALT_SRC_B		= 1ul << 9,						// (not use now) this item's status is semi controlled by an alt source (type B)
		...
		IU_SND_RECORD		= IU_S_AND_DS | IU_IS_RECORD,		// lazy combo for convenience
	...
	*/
	...
	public static class ExStorConstFaux
	{
		...
		public const string FAUX_WBK_DESC_INIT = $"Workbook for {FAUX_MODEL_TITLE}";
		public const string FAUX_WBK_DESC_ALT1 = "New Workbook Description";

		public const string FAUX_SHT_DESC_INIT = $"Sheet for {FAUX_MODEL_TITLE}";
		public const string FAUX_SHT_DESC_ALT1 = "New Sheet Description";
		...
		public const string FAUX_USER_NAME_ALT1 = "JackS";
		...
		public const string FAUX_SHT_OP_SEQ_INIT = "A00";
		public const string FAUX_SHT_OP_SEQ_ALT1 = "B01A1";
		public const string FAUX_SHT_OP_SEQ_ALT2 = "C1B1A1";

		public const UpdateRules FAUX_SHT_UPDATE_RULE_INIT = UpdateRules.UR_UPON_REQUEST;
		public const UpdateRules FAUX_SHT_UPDATE_RULE_ALT1 = UpdateRules.UR_AS_NEEDED;
		public const UpdateRules FAUX_SHT_UPDATE_RULE_ALT2 = UpdateRules.UR_NEVER;

		public const string FAUX_SHT_FAM_NAME_INIT = "Fam Name Init";
		public const string FAUX_SHT_FAM_TYPE_INIT = "Fam Type Init";
		public const string FAUX_SHT_FAM_PROP_INIT = "Fam Prop Init";

		public const string FAUX_SHT_FAM_NAME_ALT1 = "Fam Name Alt1";
		public const string FAUX_SHT_FAM_TYPE_ALT1 = "Fam Type Alt1";
		public const string FAUX_SHT_FAM_PROP_ALT1 = "Fam Prop Alt1";

		public const string FAUX_SHT_FAM_NAME_ALT2 = "Fam Name Alt2";
		public const string FAUX_SHT_FAM_TYPE_ALT2 = "Fam Type Alt2";
		public const string FAUX_SHT_FAM_PROP_ALT2 = "Fam Prop Alt2";

		public static string Faux_FatItemKey_Init = ExStorLib.FormatFamAndType(FAUX_SHT_FAM_NAME_INIT, FAUX_SHT_FAM_TYPE_INIT);
		public static string Faux_FatItemKey_Alt1 = ExStorLib.FormatFamAndType(FAUX_SHT_FAM_NAME_ALT1, FAUX_SHT_FAM_TYPE_ALT1);
		public static string Faux_FatItemKey_Alt2 = ExStorLib.FormatFamAndType(FAUX_SHT_FAM_NAME_ALT2, FAUX_SHT_FAM_TYPE_ALT2);

		public static string FauxUserName { get; set; } = FAUX_USER_NAME_INIT;

		public static void UseAltUserName()
		{
			FauxUserName = FAUX_USER_NAME_ALT1;
		}

		public static void UseAlt2UserName()
		{
	...
	public static class ExStorConst
	{
		...
		public static string VendorId { get; private set; } = "cstdio";
		public static string CompanyId { get; private set; } = "cyberstudio";
