...
namespace RevitLibrary
{
	...
	#region public properties
		...
		public static bool ShowProcessMsg {get; set;} = true;

	#endregion

		public static void ProcessMsg(string msg, int objId, bool? inout = true, [CallerMemberName] string who = "")
		{
